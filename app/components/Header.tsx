    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center gap-3 group relative z-50">
          <motion.div 
            className="relative w-10 h-10 flex items-center justify-center bg-indigo-600 rounded-xl shadow-lg"
          ...
          >
            ...
            <motion.span 
              className="text-[10px] font-bold tracking-widest text-indigo-500 uppercase"
...
function NavLink({
  ...
  return (
    ...
    >
      ...
      {isActive ? (
        <motion.span 
          className="absolute inset-0 bg-indigo-100 dark:bg-indigo-900/40 rounded-full scale-100 transition-transform duration-200"
          layoutId="highlight"
          transition={{ duration: 0.3 }}
        />
      ) : (
        <motion.span 
          className="absolute inset-0 bg-indigo-50 dark:bg-indigo-900/30 rounded-full scale-0 group-hover:scale-100 transition-transform duration-200"
          initial={{ scale: 0 }}
          whileHover={{ scale: 1 }}
          transition={{ duration: 0.2 }}
        />
